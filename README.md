...
Для начала нам надо установить виджет **Application Title**:

![](https://sun9-61.userapi.com/impg/73OMu0UKm2qqOlP1Mu-SspiKfDeRwN8PwP8VVg/vfphkUcnVU0.jpg?size=813x583&quality=96&sign=035817ccf08978c7f5e6dc77408b93c9&type=album)

Скачиваем данный [файл](https://disk.yandex.ru/d/S-cv3AvAqXh7iw "файл"), потом заходим в Latte Dock. Удаляем стандартные в KDE панели если есть. Ищем кнопку Import в разделе Layouts editor и выбираем файл, который мы только скачали. При необходимости нажмите "Использовать", выбирая макет который только что скачали.

### 4. Прозрачность консоли

Открываем управление профилями в Konsole. Создаём новый профиль с любым названием. Сразу же делаемего основным. Нажимаем изменить, выбирая наш профиль. Внешний вид -> Загрузить -> Sweet-Mars. Применяем. Изменить цветовые настройки можно нажимая на Sweet-Mars -> Изименить.

### 5. Конец кастомизации. 
Дальше мне писать лень + Вы сами можете найти интересные для Вас темы/курсоры/иконки.  Я всего лишь скажу названия того, что я использую.

Оформление рабочей среды Plasma: **Fluent Dark**
Иконки: **Fluent Dark**
Оформление окон: **Spectrum Malice**
